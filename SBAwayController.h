...
@class UIView, NSMutableDictionary, SBAlertItem, SBUIController, _UIDynamicValueAnimation, PLCameraPageController, UIImageView, NSString, SBAwayBulletinListController, SBApplication, NSMutableArray, SBDeviceLockDisableAssertion, NSDictionary, NSDate, SBShowcaseController, SBAwayView;
